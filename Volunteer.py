...
#Form Title
label_title = Label(win,text ="Apply as Volunteer",width = 18,font = ("bold",20)).place(x=520,y=50)


#Create fields
label_name = Label(win,text = "Name :",width = 15).place(x = 490,y = 130)
entry_name = Entry(win, textvariable = name ,width = 35)
...
label_education = Label(win,text = "Education :",width = 15).place(x = 490,y = 430)
entry_education = Entry(win,textvariable = education,width = 35)
