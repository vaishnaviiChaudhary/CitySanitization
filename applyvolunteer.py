...
#Form Title
label_title = Label(win,text ="Apply as Volunteer",width = 18,bg='light blue', font = ("bold",30)).place(x=850,y=50)


#Create fields
label_name = Label(win,text = "Name:",width = 15,bg='light blue',font=('bold',20)).place(x = 800,y = 130)
